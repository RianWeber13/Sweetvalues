        ...
        <ul class="space-y-1">
            ...
            <li>
                ...
                <a href="{{ route('dashboard') }}"
                    class="flex items-center gap-3 px-6 py-3 {{ request()->routeIs('dashboard') ? 'bg-pink-50 text-pink-600 border-r-4 border-pink-600' : 'text-gray-700 hover:bg-pink-50 hover:text-pink-600' }} transition-colors duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
